const Footer = () => {
    return ( 
        <footer className="bg-gray-50 dark:bg-gray-800 mt-20" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div className="grid grid-cols-2 gap-8 xl:col-span-4">
                    ...
                    <div>
                        <h3 className="text-base font-medium dark:text-white text-slate-900">Solutions</h3>
                ...
                <div className="mt-12 xl:mt-0">
                    ...
                    <fieldset className="w-full">
                        ...
                        <select id="language" name="language" className="block w-full appearance-none rounded-md border border-transparent bg-gray-700 bg-none py-2 pl-3 pr-10 text-base text-white focus:border-white focus:outline-none focus:ring-white sm:text-sm">
                    ...
                    <fieldset className="mt-4 w-full">
                        ...
                        <select id="currency" name="currency" className="block w-full appearance-none rounded-md border border-transparent bg-gray-700 bg-none py-2 pl-3 pr-10 text-base text-white focus:border-white focus:outline-none focus:ring-white sm:text-sm">
                            <option>ARS</option>
