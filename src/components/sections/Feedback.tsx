...
const Feedback = () => {
  ...
  let eltToScrollInto = React.createRef();


  const scrollToRight = () => {
    eltToScrollInto.current.scrollLeft += 200;
  }
    ...
    <div className="mt-14">
        ...
        <div className="overflow-hidden mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="sm:pt-10 overflow-hidden px-2">
            ...
            <ul role="list" ref={eltToScrollInto} className="[perspective:50rem] origin-center overflow-x-scroll flex gap-6 mb-8 transition duration-300">
            ...
            <button onClick={() => {
                scrollToLeft()
              }} className="w-14 h-14 rounded-full border border-gray-200 dark:border-gray-500 inline-flex justify-center items-center hover:scale-125">
