    ...
    return ( 
        <div className="flex flex-col gap-8 sm:grid lg:grid-cols-3 sm:grid-cols-2 items-center overflow-hidden mx-auto max-w-7xl py-20 px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative">
                <Image height={500} width={400} className="object-cover" src="https://images.unsplash.com/photo-1540304801084-0944beb20de7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8cGVyc29ubmUlMjBub2lyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60" alt="user" />
            </div>
