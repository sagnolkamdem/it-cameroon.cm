        ...
        <div className="isolate bg-white dark:bg-transparent overflow-hidden">
            ...
            <div className="absolute inset-x-0 top-[5rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top[-20rem]">
                ...
                <defs>
                    ...
                    <stop offset="1" stop-color="#17a34a"></stop>
                    </linearGradient>
                </defs>
                </svg>
            </div>
            ...
            <div>
                <div className="relative px-6 lg:px-8">
                    <div className="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                        ...
                        <div>
                            <h1 className="text-4xl font-bold tracking-tight sm:text-center dark:text-white sm:text-6xl">the best platform to get rich and promote tech made in Cameroon</h1>
