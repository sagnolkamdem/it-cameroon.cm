                ...
                <div className="space-y-8 max-w-sm mx-auto">
                    ...
                    <form className="space-y-10">
                        ...
                        <div className="space-y-5">
                            ...
                            <Input type="text" name="name" placeholder="Sagnol Kamdem" />
                            ...
                            <Input type="password" name="confirmPassword" persistType="password" placeholder="********" />
                    ...
                    <p className="font-normal text-sm dark:text-white">
                        ...
                        <a href="/login" className="ml-1 whitespace-nowrap text-primary-700">
                            Log in
                        </a>
                    </p>
                </div>
