        ...
        <li className="mb-6 group">
            <article className="relative space-y-8"  role="article">
                <div className="flex-1">
                    <div className="">
                        <Image sizes="100vw" width={0} height={0} className="object-cover md:w-full mx-auto" src="https://images.unsplash.com/photo-1547658719-da2b51169166?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8d2ViJTIwZGV2ZWxvcG1lbnR8ZW58MHx8MHx8&auto=format&fit=crop&w=900&q=60" alt="" />
                    </div>
                </div>
                <div>
                    <div className="flex items-center mt-6">
                        <div className="shrink-0">
                            <p>
                                ...
                                <Image width="40" height="40" className="w-10 h-10 rounded-full" src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fHBlcnNvbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=900&q=60" alt="author photo" />
                            </p>
                        </div>
